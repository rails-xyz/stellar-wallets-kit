...
describe('ConnectorController', () => {
    ...
    it('should find connector by active namespace only', () => {
        ...
        ChainController.state.activeChain = ConstantsUtil.CHAIN.EVM;
        expect(ConnectorController.getConnector({ id: EVM_EXPLORER_ID, rdns: '' })).toEqual(evmConnector);
        ...
        expect(ConnectorController.getConnector({ id: SOLANA_EXPLORER_ID, rdns: '' })).toEqual(solanaConnector);
    ...
    it('should return the correct connector on getConnector', () => {
        ...
        expect(ConnectorController.getConnector({ id: 'walletConnectId', rdns: '' })).toStrictEqual(walletConnectConnector);
        expect(ConnectorController.getConnector({ id: '', rdns: 'io.metamask.com' })).toStrictEqual(metamaskConnector);
